...
QT.gui_private.enabled_features = xcb accessibility-atspi-bridge egl egl_x11 eglfs evdev freetype system-freetype fontconfig gif harfbuzz ico jpeg kms linuxfb multiprocess png vnc xcb-glx xcb-render xcb-sm xlib xcb-xlib xinput2 xkb
QT.gui_private.disabled_features = angle_d3d11_qdtd direct2d directfb eglfs_brcm eglfs_egldevice eglfs_gbm eglfs_mali eglfs_viv eglfs_viv_wl integrityfb integrityhid libinput libinput-axis-api mirclient mtdev system-harfbuzz system-jpeg system-png system-xcb tslib xkbcommon-system xkbcommon-evdev
QMAKE_LIBS_XCB = -lxcb
